...
Add Category <br>
        <form action="{{route('addCategory')}}" method="POST">
            ...
            @method('POST')
<br>
            <input type="text" name="addCategory" class="mb-2 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
