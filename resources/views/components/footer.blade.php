<footer class="bg-slate-400">
    <div class="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
        <div>
            <h2 class="mb-6 text-sm font-semibold text-black-400 uppercase">Company</h2>
    ...
    <div class="py-6 px-4 bg-slate-500 md:flex md:items-center md:justify-between">
        <span class="text-sm text-black sm:text-center">© 2022 <a href="https://flowbite.com">Flowbite™</a>. All Rights Reserved.
        </span>
