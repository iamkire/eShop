    ...
    <div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
        ...
        <div class="max-w-lg mx-auto">
            ...
            <form action="{{route('users.update', Auth::user()->id)}}"
                  class="p-8 mt-6 mb-0 space-y-4 rounded-lg shadow-2xl" enctype="multipart/form-data" method="POST">
                ...
                <div class="relative mt-1">
                    ...
                    <input value={{Auth::user()->name}} type="text" name="name"
                           class="w-full p-4 pr-12 text-base border-gray-200 rounded-lg shadow-sm"/>
                </div>
                <div class="relative mt-1">
                ...
                @enderror
                <div class="relative mt-1">
                    <label for="address" class="text-base font-medium">Address</label>
                    <input value="{{Auth::user()->address}}" type="text" name="address"
                           class="w-full p-4 pr-12 text-base border-gray-200 rounded-lg shadow-sm"/>
                </div>
                <div>
                    <label class="text-base font-medium" for="image">Choose image:</label>
