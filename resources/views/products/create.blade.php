<x-app-layout>
    ...
    <div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
        ...
        <form class="bg-white p-8 mt-6 mb-0 space-y-4 rounded-lg shadow-2xl" action="{{route('products.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <p class="text-center text-3xl">Add a new Product</p>
                <div class="">
                    Product title:
